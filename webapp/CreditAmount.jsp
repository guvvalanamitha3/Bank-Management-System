...
if(uaccountnumber!=null && uamount!=null)
{
	...
	double usercreditedamount=Double.parseDouble(uamount);
	if(usercreditedamount<100000)
	{
	if(bankuserdetails.getAccountnumber()==useraccountnumber)
	{
		double balanceamount=bankuserdetails.getAmount()+usercreditedamount;
		...
		if(result!=0)
		{
			...
			if(bankstatementDAO.insertStatementDetails("CREDIT", usercreditedamount, useraccountnumber, balanceamount))
			{
